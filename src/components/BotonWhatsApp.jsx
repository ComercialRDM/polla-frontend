...
export default function BotonWhatsApp() {
    return (
        <a
            ...
            className="fixed bottom-5 right-5 z-50 flex items-center gap-2 py-3 px-4 rounded-full font-bold text-sm text-white bg-green-600 hover:bg-green-700 shadow-[0_4px_20px_rgba(34,197,94,0.4)] transition-colors"
        >
