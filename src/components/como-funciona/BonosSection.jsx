                    ...
                    {PLANES.map((plan) => (
                        <motion.div key={plan.valor} variants={fadeUp} whileHover={{ y: -4 }} transition={{ duration: 0.3 }}>
                            <Link
                                ...
                                className="cf-card flex flex-col h-full rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-7 hover:shadow-xl transition-shadow print:break-inside-avoid focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 dark:focus-visible:outline-[#FCD116]"
                            >
                                <p className="text-zinc-500 dark:text-zinc-400 text-xs font-bold uppercase tracking-wide">{plan.etiqueta}</p>
