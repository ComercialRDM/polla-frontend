        ...
        <div className="min-h-screen bg-white dark:bg-zinc-950 stadium-glow px-6 py-10 flex flex-col items-center">
            ...
            <div className="w-full max-w-md mt-6">
                ...
                <div className="flex flex-col gap-4 text-zinc-600 dark:text-zinc-300 text-sm">
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">1. Naturaleza de la Actividad Comercial</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">2. Naturaleza Jurídica del Bono</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">3. Concurso de Habilidad — Pronósticos Deportivos</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">4. Incentivos Comerciales</h2>
                    <p>
                        ...
                        <Link to="/anexo" className="text-amber-500 dark:text-amber-400 underline">Anexo 1 — Calendario de Partidos e
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">5. Exoneración de Responsabilidad</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">6. Control de Fraude y Cancelación</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">7. Propiedad Intelectual</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">8. Legislación Aplicable y Jurisdicción</h2>
                    <p>
                    ...
                    <h2 className="text-zinc-900 dark:text-white font-bold text-base mt-2">9. Aceptación</h2>
                    <p>
                        ...
                        <Link to="/privacidad" className="text-amber-500 dark:text-amber-400 underline">Política de Privacidad y Tratamiento
