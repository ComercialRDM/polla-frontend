            ...
            <div className="w-full max-w-md mt-6">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <p className="text-center text-zinc-400 text-sm">
                        ¿No tienes cuenta?{' '}
                        <Link to="/registro" className="text-amber-400 font-semibold underline">
                            Regístrate
                        </Link>
                    </p>
                ...
                {sinCuenta && (
                    <div className="mt-6 rounded-2xl border border-white/10 bg-slate-900/60 backdrop-blur-lg shadow-[0_0_15px_rgba(234,179,8,0.12)] p-5 text-center">
                        <p className="text-white font-semibold mb-2">No encontramos una cuenta con este celular 😕</p>
